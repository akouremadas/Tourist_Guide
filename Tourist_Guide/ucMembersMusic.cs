...
{
    public partial class ucMembersMusic : UserControl
    {
        //singleton user control
        private static ucMembersMusic _instance;
        public static ucMembersMusic Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new ucMembersMusic();
                }
                return _instance;
            }
        }
        public ucMembersMusic()
        {
            InitializeComponent();
        }
